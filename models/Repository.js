...
class Repository {
    ...
    checkName(name, Id){
        for(let object of this.objectsList){
            if (object.Name === name && object.Id != Id){
                return false;
            }
        }
        return true;
    ...
    checkEmpty(bookmark){
       if (bookmark.Name && bookmark.Url && bookmark.Category != null){
           return true;
       }
    ...
    checkIfValid(bookmark){
        if (this.checkEmpty(bookmark) && this.checkURL(bookmark.Url) && this.checkName(bookmark.Name, bookmark.Id)){
            return true;
        }
